...
/******************************************************************************/
	...
	static public DataResult<Identifier> NamespacedIdentifier(String defaultNamespace, String input){
		if (!input.contains(":"))
	...
	static public DataResult<Identifier> UnItemify(Identifier original){
