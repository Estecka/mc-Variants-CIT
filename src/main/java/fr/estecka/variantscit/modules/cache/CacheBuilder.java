...
{
	static public HashBiMap<EModuleHook,Item,IBakedModule> BuildAll(HashTriMap<EModuleHook,Item,Integer,List<IBakedModule>> sortedModules){
		HashBiMap<EModuleHook,Item,IBakedModule> result = new HashBiMap<>();
